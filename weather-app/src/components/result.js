...
const Result = ({ searchResult }) => { //NOTE: could've made a functional component -- hooks
  return (
    <div>
      <center><h1>Weather for the {searchResult.name} Area</h1></center>
        <div className="card text-center">
          <div className="card-body">
            ...
            <h6 className="card-subtitle mb-2 text-muted">This is the current weather information for the {searchResult.name} area.</h6>
            <img src={'http://openweathermap.org/img/w/' + searchResult.weather[0].icon + '.png'} alt="weather app banner" className="img-responsive"/>
